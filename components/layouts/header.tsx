                ...
                <div className="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <Image className="inline ltr:-ml-1 rtl:-mr-1" src="/assets/images/logo-white.svg" width={110} height={48} alt="logo" />
                        </Link>
                        <button
                            type="button"
                        ...
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto">
                            ...
                            >
                                <div className="relative">
                                    <input
                                        type="text"
                                        className="rounded-full peer form-input bg-gray-100 placeholder:tracking-widest ltr:pl-9 ltr:pr-9 rtl:pl-9 rtl:pr-9 sm:bg-transparent ltr:sm:pr-4 rtl:sm:pl-4"
                                        placeholder="Search..."
                                    />
